...
*   EL7.3 based: [Download oVirt Live 4.0.4](http://plain.resources.ovirt.org/pub/ovirt-4.0/iso/ovirt-live/ovirt-live-4.0.6.iso)

**ChangeLog**

*   Based on oVirt 4.0.6 final, see [oVirt 4.0.4 Release Notes](/release/4.0.6/)
